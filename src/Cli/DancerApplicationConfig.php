    ...
    protected function configure()
    {
        ...
        $this
            ->beginCommand('dance')
                ...
                ->addArgument('dance', Argument::OPTIONAL, 'The name of the dance')
                ...
                ->addOption('no-local', null, Option::BOOLEAN, 'Ignore local dances (searched in a higher directory till a .dances directory is found)')
